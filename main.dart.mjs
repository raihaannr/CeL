...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1383: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1385: o => o instanceof Uint8Array,
      _1386: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1387: o => o instanceof Int8Array,
      _1388: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1389: o => o instanceof Uint8ClampedArray,
      _1390: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1391: o => o instanceof Uint16Array,
      _1392: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1393: o => o instanceof Int16Array,
      _1394: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1395: o => o instanceof Uint32Array,
      _1396: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1397: o => o instanceof Int32Array,
      ...
      _1401: o => o instanceof Float32Array,
      _1402: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1403: o => o instanceof Float64Array,
      ...
      _2108: (x0,x1) => { x0.target = x1 },
      _2135: (x0,x1) => { x0.href = x1 },
      _3457: () => globalThis.window,
      _3498: x0 => x0.document,
      _3520: x0 => x0.navigator,
      _3784: x0 => x0.localStorage,
      _3890: x0 => x0.geolocation,
      _3893: x0 => x0.mediaDevices,
      _3895: x0 => x0.permissions,
      _3909: x0 => x0.userAgent,
      _4117: x0 => x0.length,
